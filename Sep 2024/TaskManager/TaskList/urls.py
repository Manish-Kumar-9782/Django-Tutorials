...
from .api_views import get_task_lists, api_add_task, api_delete_task, api_update_task


urlpatterns_apis = [
    path("api/get_task_lists", view=get_task_lists),
    path("api/add_task", view=api_add_task),
    path("api/delete_task", view=api_delete_task),
    path("api/update_task", view=api_update_task)
]
